...
" Set extra options GUI mode related
set guioptions+=a
set guioptions-=T
set guioptions+=e
set t_Co=256
...
au BufRead,BufNewFile *py,*pyw,*.c,*.h set tabstop=8 formatoptions-=o formatoptions-=r
...
" Python: 200 
" C: 200
" au BufRead,BufNewFile *.py,*.pyw,*.c,*.h set textwidth=200
